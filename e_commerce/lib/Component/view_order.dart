                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text.rich(TextSpan(children: [
                      ...
                      TextSpan(
                          text:
                              "${DateTime.fromMillisecondsSinceEpoch(arg.create_at).toString().formattedDate()}",
                    ...
                    Text.rich(TextSpan(children: [
                      TextSpan(
                          ...
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 16)),
                      TextSpan(
                          text: "${arg.name}", style: TextStyle(fontSize: 16))
                    ])),
                    Text.rich(TextSpan(children: [
                      TextSpan(
                          text: "Phone no : ",
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 16)),
                      TextSpan(
                          text: "${arg.phone}", style: TextStyle(fontSize: 16))
                    ])),
                    Text.rich(TextSpan(children: [
                      TextSpan(
