...
class MailServices {
  final gmailsmtp = gmail(dotenv.env['GMAIL_NAME']!, dotenv.env['GMAIL_PASS']!);
  sendMailFromGmail(String receiver, OrderModule order) async {
    final message = Message()
      ..from = Address(dotenv.env['GMAIL_NAME']!, "No Reply")
...
<tr style="border-bottom: 1px solid #ddd; padding:  8px;">
                ...
                <td style="padding: 8px;">${product.quentity}</td>
